...
1. In the **Basic** view, enter a title and then select a gateway from the list of [Available VPN endpoints](/docs/iaas-vpn?topic=iaas-vpn-available-vpn-endpoints).
