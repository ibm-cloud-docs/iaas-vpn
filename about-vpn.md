 ...
 * Visit [Available VPN endpoints](/docs/iaas-vpn?topic=iaas-vp-available-vpn-endpoints) for a list of VPN access points to the {{site.data.keyword.cloud_notm}} private network.
